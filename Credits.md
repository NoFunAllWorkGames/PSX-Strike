...
**B1773rm4n** · NoFunAllWorkGames

- Everything
- [GitHub commits](https://github.com/NoFunAllWorkGames/PSX-Strike/commits/main/?author=B1773rm4n)

**Suntyger** · New Horizon Studios
...
| Filename | Used for | Creator |
| ---      | ---      | ---     |
| LaserBeamVoid1–3.ogg | Mining Laser (void loop) | francobhalla |
| LaserBeamDamage1–3.ogg | Mining Laser (on hit) | francobhalla |
| LaserFire1–4.ogg | Mining Laser (ignite) | francobhalla |
...
| AmbienceEerie.ogg | Space ambience | francobhalla |
| EntityDrone.ogg | The Entity engine | francobhalla |
